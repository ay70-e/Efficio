...
import { BarChart, Bar, CartesianGrid, XAxis, YAxis, Tooltip, AreaChart,Area,  RadialBarChart,
  RadialBar,
  Legend,
} from "recharts";
...
const TaskCard = ({ task, project }) => {
  ...
  return (
    <div>
      ...
      {task.description && <p><strong>Note:</strong> {task.note}</p>}
...
<button
  ...
  className="justify-center bg-[#B8C480] text-white px-4 py-2 rounded text-sm hover:bg-[#a0ac6e]"
>
  View Project
</button>
...
const ProjectCard = ({ project }) => (
  <div >
    ...
    <h3 className="text-lg font-semibold">{project.name || "Unnamed Project"}</h3>
    ...
    <div className="flex justify-between text-gray-400">
      <p><strong className="text-black">Due:</strong> {project.endDate}</p>
...
const allTasks = [...mTasks, ...myProjects];
...
{/*==============================================================================================================*/}     
       <div  className="bg-[#FFD972] shadow-md rounded-2xl p-3  text-center 
        ...
        onSubmit={(e) => {
          ...
          setNewTask({ name: '', startDate: '', status: 0 });
        }}
        className=" space-y-2">
        <p>Add personal task</p>
        <input
          type="text"
      ...
      <div
        ...
        <div className="max-w-lg ">
          ...
          <p className="text-lg mb-6 font-medium">
           Tap to see who's on board and what they're working on today.
          </p>
          <button 
...
{/*==============================================================================================================*/}      
<div className="flex md:flex-row items-center justify-between px-4 ">
      ...
      <Carousel className="w-2xl">
        <CarouselContent>
          {projects.map(project => (
            <CarouselItem key={project.id} className="md:basis-1/2 pt-3">
              <div className="bg-white shadow-md rounded-2xl p-6 hover:shadow-xl hover:scale-105 hover:-translate-y-1 transition duration-300">
                <ProjectCard project={project} />

                {/* View Project */}
                <div className="flex justify-end mt-4">
                  <button
                    onClick={() => navigate(`/ProjectsDashboard/${project.id}`, { state: { projectId: project.id } })}
 ...
 {/*==============================================================================================================*/} 
    <div className="bg-white px-6 rounded-2xl shadow-md mb-3">
      <h2 className="text-xl font-semibold m-4">Assignments ({myProjects.length})</h2>
  ...
  <AlertDialogContent className="text-center">
    ...
    <AlertDialogFooter className="justify-center mt-2 px-50">
      <AlertDialogAction
        className="bg-[#FFB7B2] hover:bg-[#FFD972] text-black py-2  rounded-full text-sm  "
      ...
      <form className="flex-1">
        ...
        <tr className="flex justify-between border-b border-gray-400 py-2">
          <td>
            <label htmlFor={`p-${index}`} className="text-sm font-medium">
              {task.name}
...
{/*==============================================================================================================*/}
  {/*     Charts  */}
{/*==============================================================================================================*/} 
{/*     Chart of Projects Progress */}
  <div className="bg-white p-0 rounded-2xl shadow-md mb-3 ">
    <h2 className="text-xl font-semibold m-4 ">Projects Progress</h2>
